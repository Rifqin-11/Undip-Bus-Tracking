...
export function EditBuggyModal({ isOpen, buggy, onClose, onSuccess }: EditBuggyModalProps) {
          ...
          <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 pointer-events-none">
            ...
            >
              <div className="mb-5 flex items-center justify-between">
                <h3 className="text-[18px] font-bold text-slate-800 tracking-tight">Edit Armada</h3>
                <button
                  type="button"
                  onClick={onClose}
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    <label className="block text-[12px] font-bold text-slate-700 mb-1.5 ml-1">Status</label>
                    <button 
                      type="button" 
