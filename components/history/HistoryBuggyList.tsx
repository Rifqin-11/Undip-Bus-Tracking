                    ...
                    <div className="flex flex-1 items-center gap-3">
                       ...
                       <div className="flex flex-col justify-center">
                         <div className="flex items-baseline gap-1.5">
                            <span className="text-[17px] font-bold text-slate-800 tracking-tight leading-none">{opt.name}</span>
                         </div>
                       </div>
                    </div>
                  ...
                  <div className="mt-2.5 flex flex-wrap items-center gap-x-2 gap-y-1.5 pr-1">
                     ...
                     {latestSession ? (
                       <p className="text-[10px] font-medium text-slate-600">
                         <span className="font-bold text-slate-800">{sessionsForBuggy.length} sesi</span> · trkhr {fmtDate(latestSession.startedAt)} {fmtTime(latestSession.startedAt)}
                       </p>
                     ) : (
