  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="relative z-10 mt-auto flex w-full items-center justify-between rounded-2xl border border-slate-200/60 bg-white p-2 shadow-[0_2px_6px_rgba(0,0,0,0.02)] transition-all hover:border-slate-300 hover:shadow-sm"
      >
        <div className="flex min-w-0 flex-1 items-center gap-2">
          {/* Subtle Icon Box */}
          <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-[10px] bg-slate-50 text-slate-500 border border-slate-100">
        ...
        {/* Action Arrow */}
        <div className="ml-1.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-slate-50 text-slate-400 transition-colors group-hover:bg-[#0f1a3b] group-hover:text-white">
