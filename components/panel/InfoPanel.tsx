  ...
  return (
    <div className="rounded-3xl border border-slate-200/80 bg-white/70 p-3">
      ...
      <div className="space-y-2">
        ...
        {/* Kontak */}
        <div className="rounded-[20px] bg-white p-4 shadow-[0_8px_20px_rgba(15,26,59,0.15)]">
          ...
          <div className="space-y-2 text-[11px]">
            <div className="flex items-center gap-2">
              ...
              <a href="tel:0247460024" className="text-slate-400 hover:text-slate-600">(024) 7460024</a>
            </div>
            <div className="flex items-center gap-2">
              ...
              <a href="mailto:humas@undip.ac.id" className="text-slate-400 hover:text-slate-600">humas@undip.ac.id</a>
            </div>
          </div>
        </div>
      </div>
