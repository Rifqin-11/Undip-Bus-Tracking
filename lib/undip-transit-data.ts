...
export const STOP_LOCATIONS: StopLocation[] = [
  { name: "Rusunawa Undip", lat: -7.054518537168431, lng: 110.44413919120406 },
  {
  ...
  { name: "Student Center", lat: -7.053615652182, lng: 110.43919618890992 },
  {
  ...
  { name: "Widya Puraya", lat: -7.049832325888632, lng: 110.43849680096805 },
  { name: "Teknik Elektro", lat: -7.049445426133159, lng: 110.43980141026086 },
  {
  ...
  { name: "Bundaran Undip", lat: -7.055973568692425, lng: 110.43939589722012 },
];

export const LANDMARK_LOCATIONS: LandmarkLocation[] = [
  { name: "Jurusan Geologi", lat: -7.04999, lng: 110.44095 },
  { name: "Teknik Geologi", lat: -7.04999, lng: 110.44095 },
  { name: "Geologi", lat: -7.04999, lng: 110.44095 },
];
...
const UNDIP_ROUTE_STOPS = STOP_LOCATIONS.map((stop) => stop.name);

export const SOURCE_BUGGIES: SourceBuggy[] = [
  {
    id: 1,
    name: "Buggy 01",
    eta: 2,
