            ...
            <div>
              <div className="mb-6 flex items-center gap-3">
                ...
                <div>
                  ...
                  <h1 className="text-xl font-bold tracking-tight">SIMOBI Admin</h1>
                </div>
              </div>
          ...
          <div className="rounded-3xl border border-white/45 bg-white/72 p-5 backdrop-blur-xl sm:p-7">
            ...
            <form className="space-y-3.5" onSubmit={handleSubmit}>
              ...
              <button
                ...
                className="liquid-glass-cta mt-1 h-11 w-full rounded-2xl text-[14px] font-semibold text-white transition disabled:cursor-not-allowed disabled:opacity-70"
              >
